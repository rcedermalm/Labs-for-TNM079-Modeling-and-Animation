...
public:
  ...
  inline float GetValue(int i, int j, int k) const {
  ...
  inline bool GetMask(int i, int j, int k) const {
    return mMask.GetValue(i, j, k);
  }
  inline void SetMask(int i, int j, int k, bool b) {
    mMask.SetValue(i, j, k, b);
  }

  void SetInsideConstant(float insideConstant) {
    mInsideConstant = insideConstant;
  }
  inline const float GetInsideConstant() const { return mInsideConstant; }

  void SetOutsideConstant(float outsideConstant) {
