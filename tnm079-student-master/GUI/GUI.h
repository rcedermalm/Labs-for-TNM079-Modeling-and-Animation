...
protected:
  ...
  virtual void AddObjectSimpleDecimationMesh(wxCommandEvent &event) {
    event.Skip();
  }
  virtual void AddObjectQuadricDecimationMesh(wxCommandEvent &event) {
    event.Skip();
  }
  virtual void AddObjectCubicSpline(wxCommandEvent &event) { event.Skip(); }
  virtual void AddObjectSubdivisionCurve(wxCommandEvent &event) {
    event.Skip();
  }
  virtual void AddObjectLoopSubdivisionMesh(wxCommandEvent &event) {
    event.Skip();
  }
  virtual void AddObjectStrangeSubdivisionMesh(wxCommandEvent &event) {
    event.Skip();
  }
  ...
  virtual void AddObjectQuadricEllipsoid(wxCommandEvent &event) {
    event.Skip();
  }
  virtual void AddObjectQuadricCone(wxCommandEvent &event) { event.Skip(); }
  virtual void AddObjectQuadricParaboloid(wxCommandEvent &event) {
    event.Skip();
  }
  virtual void AddObjectQuadricHyperboloid(wxCommandEvent &event) {
    event.Skip();
  }
  ...
  virtual void FluidVisualizeVoxelsClassification(wxCommandEvent &event) {
    event.Skip();
  }
